    ...
    <div style="width: 80%;">
        ...
        <dialog id="tambah" class="modal">
            ...
            if (isset($_POST['tambah'])) {
                ...
                $query = $koneksi->query("INSERT INTO tbl_petugas SET 
                    nama_petugas = '$nama',
                    username = '$username',
                    password = '$password',
                    telp = '$telp',
    ...
    <div class="tab" style="width: 83%;">
        <div class="overflow-x-auto bg-base-300" style="width: 100%;border-radius: 10px;">
            <table class="table">
                ...
                <tbody>
                    <?php
                    $query = $koneksi->query("SELECT * FROM tbl_petugas");
                    $no = 1;
                    while ($row = mysqli_fetch_array($query)) { ?>
                        ...
                        <tr class='hover'>
                            ...
                            <td><?= $row['level'] ?></td>
                            <td align="center">
                                <a href="../config/ep.php?ubah=<?= $row['id_petugas'] ?>"><button class="btn btn-primary">Ubah</button></a>
                                <a href="edit.php?hapusp=<?= $row['id_petugas'] ?>"><button class="btn btn-error">Hapus</button></a>
                            </td>
